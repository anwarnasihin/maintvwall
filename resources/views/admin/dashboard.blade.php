...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body" style="position: relative; background-image: url('{{ asset('assets/dist/img/virtual background - bekasi-04.png') }}'); background-size: cover; background-repeat: no-repeat; min-height: 45em; text-align: center;">
            ...
            {{-- Logo --}}
            <img src="{{ asset('assets/dist/img/Road-To-45.png') }}" alt="Logo Road To 45" style="display: block; margin: 0 auto;" width="175" height="185">
